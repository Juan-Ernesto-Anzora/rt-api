...
TENANT_SETTINGS_MANAGE_PERMISSION = "tenant.settings.manage"
FEATURE_FLAGS_MANAGE_PERMISSION = "featureflags.manage"
NOTIFICATIONS_MANAGE_PERMISSION = "notifications.manage"
